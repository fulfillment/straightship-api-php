...
/**
 * InputUnpackedItem Class Doc Comment
 *
 * @category Class
 * @package  namespace Fulfillment\StraightShip\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InputUnpackedItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InputUnpackedItem';
    ...
    {
        $this->container['unit_width'] = isset($data['unit_width']) ? $data['unit_width'] : null;
        $this->container['unit_height'] = isset($data['unit_height']) ? $data['unit_height'] : null;
        $this->container['unit_length'] = isset($data['unit_length']) ? $data['unit_length'] : null;
     ...
     * Sets unit_width
     *
     * @param double $unit_width Unit width
     *
     * @return $this
     */
     ...
     * Sets unit_height
     *
     * @param double $unit_height Unit height
     *
     * @return $this
     */
     ...
     * Sets unit_length
     *
     * @param double $unit_length Unit length
     *
     * @return $this
     */
