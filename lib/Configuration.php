...
namespace Fulfillment\StraightShip\Client;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api-us.techship.io/';
    ...
    {
        $report  = 'PHP SDK (namespace Fulfillment\StraightShip\Client) Debug Report:' . PHP_EOL;
